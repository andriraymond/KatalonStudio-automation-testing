...
if (Mobile.verifyElementVisible(findTestObject('00. General/00.1 Splashscreen/00.1 splashScreenSection'), 0, FailureHandling.OPTIONAL)) {
    Mobile.callTestCase(findTestCase('00. General/00.1 Splashscreen'), [:], FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.takeScreenshot(((((GlobalVariable.pathScreenshots + '_') + todaysDate) + '_') + nowTime) + '.png', FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.delay(1 //Mobile.takeScreenshot(((pathScreenshots + todaysDate) + nowTime) + '.png')
        //Mobile.takeScreenshot(((pathScreenshots + todaysDate) + nowTime) + '.png')
        )
} else if (Mobile.verifyElementVisible(findTestObject('00. General/00. btnLogin'), 0, FailureHandling.CONTINUE_ON_FAILURE)) {
    Date today = new Date()
