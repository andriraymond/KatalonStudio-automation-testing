...
if(Mobile.verifyElementVisible(findTestObject('00. General/00.1 Splashscreen/00.1 splashScreenSection'),5, FailureHandling.CONTINUE_ON_FAILURE)) {
...
}else if(Mobile.verifyElementVisible(findTestObject('00. General/00. btnLogin'), 0)) {
